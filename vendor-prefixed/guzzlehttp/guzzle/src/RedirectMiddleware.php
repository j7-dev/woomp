...
use Woomp\GuzzleHttp\Exception\BadResponseException;
use Woomp\GuzzleHttp\Exception\TooManyRedirectsException;
...
class RedirectMiddleware
{
    ...
    public function checkRedirect(RequestInterface $request, array $options, ResponseInterface $response)
    {
        ...
        if (\Woomp\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $nextRequest->getUri()) && defined('\CURLOPT_HTTPAUTH')) {
    ...
    public function modifyRequest(RequestInterface $request, array $options, ResponseInterface $response)
    {
        ...
        $modify['uri'] = $uri;
        \Woomp\GuzzleHttp\Psr7\rewind_body($request);
        ...
        if (\Woomp\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $modify['uri'])) {
            $modify['remove_headers'][] = 'Authorization';
            $modify['remove_headers'][] = 'Cookie';
        }
        return \Woomp\GuzzleHttp\Psr7\modify_request($request, $modify);
    }
    /**
    ...
    {
        $location = \Woomp\GuzzleHttp\Psr7\UriResolver::resolve($request->getUri(), new Psr7\Uri($response->getHeaderLine('Location')));
