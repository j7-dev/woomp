...
use Woomp\Symfony\Polyfill\Php72 as p;
...
if ('\\' === \DIRECTORY_SEPARATOR && !function_exists('woomp_sapi_windows_vt100_support')) {
    function woomp_sapi_windows_vt100_support($stream, $enable = null) { return p\Php72::sapi_windows_vt100_support($stream, $enable); }
}
