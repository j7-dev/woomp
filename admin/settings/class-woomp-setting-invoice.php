			...
			case 'ecpay':
				if ( wc_string_to_bool( get_option( 'wc_woomp_enabled_ecpay_invoice' ) ) ) {
					$settings = [
						...
						[
							'name'     => '通關方式',
							'desc'     => '當課稅類別為[零稅率]時，為必填',
							'desc_tip' => true,
							'type'     => 'select',
							'id'       => 'wc_woomp_ecpay_invoice_clearance_mark',
							'options'  => [
								''  => __( '請選擇', 'woomp' ),
								'1' => __( '非經海關出口', 'woomp' ),
								'2' => __( '經海關出口', 'woomp' ),
						...
						[
							'name'     => '特種課稅類別',
							'desc'     => '當課稅類別為[免稅]、[應稅（特種稅率）]時，為必填',
							'desc_tip' => true,
							'type'     => 'select',
							'id'       => 'wc_woomp_ecpay_invoice_special_tax_type',
							'options'  => [
								'0' => __( '請選擇', 'woomp' ),
								'1' => __( '酒家及有陪侍服務之茶室、咖啡廳、酒吧之營業稅稅率，稅率為25%', 'woomp' ),
								'2' => __( '夜總會、有娛樂節目之餐飲店之營業稅稅率，稅率為15%', 'woomp' ),
								'3' => __( '銀行業、保險業、信託投資業、證券業、期貨業、票券業及典當業之專屬本業收入(不含銀行業、保險業經營銀行、保險本業收入)之營業稅稅率，稅率為2%', 'woomp' ),
								'4' => __( '保險業之再保費收入之營業稅稅率，稅率為1%', 'woomp' ),
								'5' => __( '銀行業、保險業、信託投資業、證券業、期貨業、票券業及典當業之非專屬本業收入之營業稅稅率，稅率為5%', 'woomp' ),
								'6' => __( '銀行業、保險業經營銀行、保險本業收入之營業稅稅率(適用於民國103年07月以後銷售額) ，稅率為5%', 'woomp' ),
								'7' => __( '銀行業、保險業經營銀行、保險本業收入之營業稅稅率(適用於民國103年06月以前銷售額) ，稅率為5%', 'woomp' ),
								'8' => __( '空白為免稅或非銷項特種稅額之資料', 'woomp' ),
							],
							'default'  => '0',
						],
						[
