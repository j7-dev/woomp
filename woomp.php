		...
		<form class="w-fit mx-auto" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
			<div class="mt-24 flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 z-50 relative">
				<div class="sm:mx-auto sm:w-full sm:max-w-sm">
					...
					?>
					<p class='text-gray-500'>好用版擴充是款免費外掛，但請先到 <a class="font-semibold leading-6 text-primary hover:text-primary-400" target="_blank" href="<?= self::$buy_license_link; ?>">站長路可網站</a>
						註冊帳號，即可索取授權碼。有任何客服問題，請私訊站長路可網站右下方對話框，或是來信 <a class="font-semibold leading-6 text-primary hover:text-primary-400" href="mailto:<?= self::$support_email; ?>" target="_blank">
							<?= self::$support_email; ?>
						</a></p>
				</div>
				...
				<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
					...
					<p class="mt-10 text-center text-sm text-gray-400">
						網站速度不夠快？
						<a target="_blank" href="https://cloud.luke.cafe/" class="font-semibold leading-6 text-primary hover:text-primary-400">我們的主機代管服務</a>
						提供30天免費試用
					</p>
