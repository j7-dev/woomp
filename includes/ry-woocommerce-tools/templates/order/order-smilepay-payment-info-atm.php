...
<section class="woocommerce-order-details">
	...
	<table class="woocommerce-table woocommerce-table--payment-details payment_details">
		<tbody>
			<tr>
				<td>
					<?php echo __( 'Bank', 'ry-woocommerce-tools' ); ?>
				</td>
				<td><?php echo _x( $order->get_meta( '_smilepay_atm_BankCode' ), 'Bank code', 'ry-woocommerce-tools' ); ?>
				</td>
			</tr>
			<tr>
				<td>
					<?php echo __( 'Bank code', 'ry-woocommerce-tools' ); ?>
				</td>
				<td><?php echo $order->get_meta( '_smilepay_atm_BankCode' ); ?>
				</td>
			</tr>
			<tr>
				<td>
					<?php echo __( 'ATM Bank account', 'ry-woocommerce-tools' ); ?>
				</td>
				<td><?php echo wordwrap( $order->get_meta( '_smilepay_atm_vAccount' ), 4, '<span> </span>', true ); ?>
				</td>
			</tr>
			<tr>
				<td>
