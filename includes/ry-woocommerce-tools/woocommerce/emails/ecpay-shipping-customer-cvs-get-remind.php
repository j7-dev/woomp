<?php
if ( ! class_exists( 'RY_ECPay_Shipping_Email_Customer_CVS_Get_Remind', false ) ) {
	class RY_ECPay_Shipping_Email_Customer_CVS_Get_Remind extends WC_Email {

		public function __construct() {
			$this->id             = 'ry_ecpay_shipping_customer_cvs_get_remind';
			$this->customer_email = true;

			$this->title          = __( '超商取貨提醒', 'ry-woocommerce-tools' );
			$this->description    = __( '這是在商品經由綠界物流到店後距離取貨到期日前一天的通知。', 'ry-woocommerce-tools' );
		...
		public function get_default_subject() {
			return __( '您在 {site_title} 訂購的商品明天就要到期了，請儘速前往取貨', 'ry-woocommerce-tools' );
		}
...
return new RY_ECPay_Shipping_Email_Customer_CVS_Get_Remind();
