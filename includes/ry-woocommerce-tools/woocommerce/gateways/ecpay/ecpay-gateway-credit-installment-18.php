<?php
class WMP_ECPay_Gateway_Credit_Installment_18 extends RY_ECPay_Gateway_Base {

	public $payment_type = 'Credit';

	public function __construct() {

		$this->id                 = 'wmp_ecpay_credit_installment_18';
		$this->has_fields         = false;
		$this->order_button_text  = '綠界信用卡分期付款';
		$this->method_title       = '綠界信用卡（分十八期）';
	...
	public function process_payment( $order_id ) {
		...
		$order->add_order_note( '使用綠界信用卡分期付款（分十八期）' );
		$order->save();
