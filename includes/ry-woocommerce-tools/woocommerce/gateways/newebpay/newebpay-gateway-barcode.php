...
<table>
	<tr>
		...
		<td><?php echo $order->get_meta( '_newebpay_barcode_Barcode1' ); ?>
		</td>
	</tr>
	<tr>
		<td><?php echo __( 'Barcode 2', 'ry-woocommerce-tools' ); ?>
		</td>
		<td><?php echo $order->get_meta( '_newebpay_barcode_Barcode2' ); ?>
		</td>
	</tr>
	<tr>
		<td><?php echo __( 'Barcode 3', 'ry-woocommerce-tools' ); ?>
		</td>
		<td><?php echo $order->get_meta( '_newebpay_barcode_Barcode3' ); ?>
		</td>
	</tr>
	<tr>
		<td><?php echo __( 'Payment deadline', 'ry-woocommerce-tools' ); ?>
		</td>
		<td><?php echo $order->get_meta( '_newebpay_barcode_ExpireDate' ); ?>
		</td>
	</tr>
</table>
		<?php
