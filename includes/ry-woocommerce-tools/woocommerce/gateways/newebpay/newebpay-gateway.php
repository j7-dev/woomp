...
final class RY_NewebPay_Gateway {
	...
	public static function init() {
		...
		include_once RY_WT_PLUGIN_DIR . 'woocommerce/gateways/newebpay/newebpay-gateway-credit-installment-3.php';
		include_once RY_WT_PLUGIN_DIR . 'woocommerce/gateways/newebpay/newebpay-gateway-credit-installment-6.php';
		include_once RY_WT_PLUGIN_DIR . 'woocommerce/gateways/newebpay/newebpay-gateway-credit-installment-12.php';
		include_once RY_WT_PLUGIN_DIR . 'woocommerce/gateways/newebpay/newebpay-gateway-credit-installment-18.php';
		include_once RY_WT_PLUGIN_DIR . 'woocommerce/gateways/newebpay/newebpay-gateway-credit-installment-24.php';
		include_once RY_WT_PLUGIN_DIR . 'woocommerce/gateways/newebpay/newebpay-gateway-credit-installment-30.php';
	...
	public static function add_method( $methods ) {
		...
		if ( wc_string_to_bool( get_option( 'wmp_newebpay_credit_installment' ) ) ) {
			$methods[] = 'WMP_NewebPay_Gateway_Credit_Installment_3';
			$methods[] = 'WMP_NewebPay_Gateway_Credit_Installment_6';
			$methods[] = 'WMP_NewebPay_Gateway_Credit_Installment_12';
			$methods[] = 'WMP_NewebPay_Gateway_Credit_Installment_18';
			$methods[] = 'WMP_NewebPay_Gateway_Credit_Installment_24';
			$methods[] = 'WMP_NewebPay_Gateway_Credit_Installment_30';
		}
