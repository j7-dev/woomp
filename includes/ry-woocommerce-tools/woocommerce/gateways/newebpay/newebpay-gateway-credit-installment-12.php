<?php
class WMP_NewebPay_Gateway_Credit_Installment_12 extends RY_NewebPay_Gateway_Base {

	public $payment_type = 'InstFlag';

	public function __construct() {

		$this->id                 = 'wmp_newebpay_credit_installment_12';
		$this->has_fields         = false;
		$this->order_button_text  = '藍新信用卡分期付款';
		$this->method_title       = '藍新信用卡（分十二期）';
	...
	public function process_payment( $order_id ) {
		...
		$order->add_order_note( '使用藍新信用卡分期付款（分十二期）' );
