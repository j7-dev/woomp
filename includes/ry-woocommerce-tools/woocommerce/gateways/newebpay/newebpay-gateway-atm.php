...
<table>
	<tr>
		...
		<td><?php echo _x( $order->get_meta( '_newebpay_atm_BankCode' ), 'Bank code', 'ry-woocommerce-tools' ); ?> (<?php echo $order->get_meta( '_newebpay_atm_BankCode' ); ?>)</td>
	</tr>
	<tr>
		<td><?php echo __( 'ATM Bank account', 'ry-woocommerce-tools' ); ?>
		</td>
		<td><?php echo $order->get_meta( '_newebpay_atm_vAccount' ); ?>
		</td>
	</tr>
	<tr>
		<td><?php echo __( 'Payment deadline', 'ry-woocommerce-tools' ); ?>
		</td>
		<td><?php echo $order->get_meta( '_newebpay_atm_ExpireDate' ); ?>
		</td>
	</tr>
</table>
		<?php
