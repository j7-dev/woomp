(function ( $ ) {
	...
	$( document ).on(
		...
		function () {
			...
			$.get(
				ajax_funcashier_object.ajax_accept_payment_url,
				data,
				function ( response ) {
					if ( response.success ) {
	...
	$( document ).on(
		...
		function () {
			...
			$.get(
				ajax_funcashier_object.ajax_query_order_url,
				data,
				function ( response ) {
					if ( response.success ) {
						console.log( response.data.trans_status );
	...
	$( document ).on(
		...
		function () {
			...
			$.get(
				ajax_funcashier_object.ajax_ship_order_url,
				data,
				function ( response ) {
					if ( response.success ) {
						console.log( response.data.trans_status );
