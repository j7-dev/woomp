...
class Checkout {
	...
	public function set_invoice_meta( $order_id ) {
		...
		// 新增載具編號
		if ( isset( $_POST['ezpay-carrier-number'] ) && ( $_POST['ezpay-individual-invoice'] == '手機代碼' || $_POST['ezpay-individual-invoice'] == '自然人憑證' ) ) {
	...
	public function enqueue_scripts() {
		if ( is_checkout() ) {
			...
			wp_register_script( 'woomp_ezpay_invoice', EZPAYINVOICE_PLUGIN_URL . 'assets/js/checkout.js', array( 'jquery' ), '1.0.6', true );
			wp_localize_script(
				'woomp_ezpay_invoice',
