	...
	public static function activate() {
		...
		if ( ! get_option( 'woocommerce_woomp_cod_gateway_settings' ) ) {
			$gateway_setting = [
				...
				'enable_for_methods' => [ 'ry_ecpay_shipping_home_ecan:7', 'ry_ecpay_shipping_home_tcat:6' ],
			];
		...
		if ( ! get_option( 'woocommerce_cod_settings' ) ) {
			$gateway_setting = [
				...
				'enable_for_methods' => [ 'ry_ecpay_shipping_cvs_711', 'ry_ecpay_shipping_cvs_711:3', 'ry_ecpay_shipping_cvs_hilife', 'ry_ecpay_shipping_cvs_hilife:4', 'ry_ecpay_shipping_cvs_family', 'ry_ecpay_shipping_cvs_family:5', 'ry_newebpay_shipping_cvs:15' ],
			];
